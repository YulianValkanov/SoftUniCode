...
namespace Entity_Framework_Introduction_Exercise.Data
{
    using Entity_Framework_Introduction_Exercise.Models;
    using System;
    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-8164Q69;Database=SoftUni;Integrated Security=True;");
            }
        }
