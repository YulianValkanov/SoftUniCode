           ...
           ImportProjectDto[] projectDtos=  (ImportProjectDto[])xmlSerializer.Deserialize(sr);
            ...
            foreach (var projectDto in projectDtos)
            {
                ...
                foreach (var TaskDTO in projectDto.Tasks)
                {
                   ...
                   (TaskDTO.TaskOpenDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime taskOpenDate);
                  ...
                  (TaskDTO.TaskDueDate, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out DateTime taskDueDate);
